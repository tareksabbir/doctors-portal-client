...
import doctor from '../../assets/images/Doctors-rafiki.png'

const Banner = () => {
    return (
        <>
            <section class=" flex flex-col lg:flex-row justify-between gap-6 sm:gap-10 md:gap-16 lg:px-24 px-10">
                ...
                <div class="xl:w-5/12 flex flex-col justify-center items-center lg:items-start sm:text-center lg:text-left lg:py-12 xl:py-24">
                    <h1 class="mt-10 lg:mt-12 text-black-800 text-4xl sm:text-5xl md:text-5xl font-bold mb-8 md:mb-12">Don't worry, Your health matters to us..</h1>
                    ...
                    <div class="flex flex-col sm:flex-row sm:justify-center lg:justify-start gap-2.5">
                        <a href="/" class="inline-block bg-primary hover:bg-indigo-600 active:bg-indigo-700 focus-visible:ring ring-indigo-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">Book now</a>
                ...
                <div class="xl:w-5/12 lg:h-auto h-full">
                    <img src={doctor} loading="lazy" alt="" class="w-full h-full object-cover object-center" />
                </div>
            ...
            <section class="lg:mt-3 flex flex-col lg:flex-row justify-between items-center border-t gap-10 lg:gap-8 pt-8 lg:px-24">
                ...
                <div class="grid grid-cols-2 md:flex md:divide-x gap-4 -mx-6 md:-mx-8">
                    ...
                    <div class="px-6 md:px-8">
                        <span class="block text-primary text-lg md:text-xl font-bold text-center md:text-left">A couple</span>
                        <span class="block text-gray-800 text-sm md:text-base font-semibold text-center md:text-left">Coffee breaks</span>
                    </div>
                </div>
